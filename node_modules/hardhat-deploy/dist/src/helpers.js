    ...
    async function _deployViaDiamondProxy(name, options) {
        ...
        if (changesDetected) {
            if (!proxy) {
                ...
                const diamondDeployment = Object.assign(Object.assign({}, oldDeployment), { linkedData: options.linkedData, address: proxy.address, abi, facets: facetSnapshot, diamondCut: facetCuts, execute: options.execute });
                // TODO reenable history with options
                if (oldDeployment.history) {
