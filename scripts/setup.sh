...
# if zk/setup does not exist, make folder
[ -d zk/setup ] || mkdir zk/setup

# Starts Powers Of Tau ceremony, creating the file pot12_0000.ptau
yarn snarkjs powersoftau new bn128 12 zk/setup/pot12_0000.ptau -v
...
yarn snarkjs powersoftau contribute zk/setup/pot12_0000.ptau zk/setup/pot12_0001.ptau \
    --name="First contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
yarn snarkjs powersoftau contribute zk/setup/pot12_0001.ptau zk/setup/pot12_0002.ptau \
    --name="Second contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
yarn snarkjs powersoftau contribute zk/setup/pot12_0002.ptau zk/setup/pot12_0003.ptau \
    --name="Third contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"

# Verify
yarn snarkjs powersoftau verify zk/setup/pot12_0003.ptau
...
yarn snarkjs powersoftau beacon zk/setup/pot12_0003.ptau zk/setup/pot12_beacon.ptau \
...
yarn snarkjs powersoftau prepare phase2 zk/setup/pot12_beacon.ptau zk/setup/pot12_final.ptau -v

# Verify the final ptau file. Creates the file pot12_final.ptau
yarn snarkjs powersoftau verify zk/setup/pot12_final.ptau
